    ...
    <>
      <header
        className={cn(
          ...
          overlay
            ...
            : "border-b border-white/10 bg-[#07080A]/92",
      ...
      >
        <div className="mx-auto flex h-[4.25rem] max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <button
            type="button"
            className="relative z-[90] inline-flex size-10 items-center justify-center rounded-md text-zinc-200 md:hidden"
            aria-expanded={open}
      ...
      {open ? (
        <div className="fixed inset-0 z-[70] bg-[#07080A] pt-[4.25rem] md:hidden">
